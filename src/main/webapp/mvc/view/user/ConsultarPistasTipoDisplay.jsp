...
<html>
		<head>
				<meta charset="UTF-8">
				<title>Consultar Pistas por Fecha</title>
		</head>
		<body>
				<p id="message"><%= mensajeNextPage %></p>
						<p> Escriba la fecha de la reserva</p>
						<form id="formConsultaFechaUsuario" method="post" action="/WebProyectoPW/ConsultarPistas">
								<div>
										<p>
